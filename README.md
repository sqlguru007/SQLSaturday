...
![onprem-adf-azure-synapse](https://github.com/user-attachments/assets/99aad559-f617-447f-a0cc-1587c38150fc)



🎯 Learning Objectives

 1. By completing this lab, participants will:

 2. Understand the core architecture of Azure Data Factory and how it orchestrates data movement.

 3. Set up linked services, datasets, and pipelines in ADF.

 4. Create data ingestion workflows from on-prem SQL Server to Azure Data Lake.

 5. Use Data Flows and Mapping Data Flows to perform transformations.

 6. Load transformed data into Azure Synapse Analytics for reporting and analytics.

 7. Monitor and debug pipeline runs in ADF.
